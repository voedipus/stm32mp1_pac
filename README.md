...
```rust
use stm32mp1::stm32mp151;

let mut peripherals = stm32mp151::Peripherals::take().unwrap();
...
|:------:|:-------:|:-----:|
| stm32mp151 | STM32MP151 | [RM0441](https://www.st.com/resource/en/reference_manual/rm0441-stm32mp151-advanced-armbased-32bit-mpus-stmicroelectronics.pdf), [st.com](https://www.st.com/en/microcontrollers-microprocessors/stm32mp151.html) |
